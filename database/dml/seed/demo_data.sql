...
BEGIN
    ...
    (
        ...
        'champion-balance',
        0.25, 0.35, 0.40,
        'Players are discussing recent balance changes to  and . The community is divided on whether the nerfs went far enough.',
        '[{"text": " nerfs finally happened but he still feels strong", "platform": "youtube", "sentiment": "negative", "confidence": 0.85}]'::jsonb,
        156,
        '{"youtube": 70, "tier-site": 20, "official-news": 10}'::jsonb,
        v_period_start, v_now, '14.24', 0.82,
        v_now, v_now
    ),
    (
        uuid_generate_v4(),
        ...
        v_period_start, v_now, '14.24', 0.78,
        v_now, v_now
    ),
    (
        uuid_generate_v4(),
        ...
        'new-skins',
        0.65, 0.25, 0.10,
        'The new High Noon skin line is receiving overwhelmingly positive reception.',
        '[{"text": "High Noon  might be the best legendary of the year", "platform": "youtube", "sentiment": "positive", "confidence": 0.95}]'::jsonb,
        89,
        '{"youtube": 80, "tier-site": 5, "official-news": 15}'::jsonb,
        v_period_start, v_now, '14.24', 0.88,
        v_now, v_now
    ),
    (
        uuid_generate_v4(),
        ...
        'pro-play-esports',
        0.55, 0.35, 0.10,
        'Worlds 2026 bracket predictions are generating excitement.',
        '[{"text": "T1 looking dominant,  showing why hes the GOAT", "platform": "youtube", "sentiment": "positive", "confidence": 0.89}]'::jsonb,
        134,
        '{"youtube": 75, "tier-site": 10, "official-news": 15}'::jsonb,
        v_period_start, v_now, '14.24', 0.85,
        v_now, v_now
    ),
    (
        uuid_generate_v4(),
        ...
        '[{"text": "Client froze in champ select, lost LP for dodging", "platform": "youtube", "sentiment": "negative", "confidence": 0.92}]'::jsonb,
        178,
        '{"youtube": 70, "tier-site": 15, "official-news": 15}'::jsonb,
        v_period_start, v_now, '14.24', 0.79,
        v_now, v_now
    );
    ...
    (
        ...
        ' Nerfs Finally Hit! Is He Still Broken?',
        'Breaking down the latest  changes and whether they actually matter in solo queue.',
    ...
    (
        ...
        'High Noon  Skin Spotlight',
        'Full preview of the new legendary skin with all chromas.',
    ...
    (
        ...
        'T1 vs BLG - Worlds Finals Preview',
    ...
    (
        ...
        'Best Champion Tier List Patch 14.24',
